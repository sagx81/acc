...
penalties_csv = os.path.join(project_root, "acc", "input","penalties.csv")
        ...
        try:
            ...
            with open(csv_file, mode='r', encoding='utf-8') as file:
                ...
                for row in reader:
                    ...
                    driver = row['Kierowca']                
                    timing = str(row['Łączny czas'])  #str(row['Laczny czas'])
                    
                    # bestLap = row['Naj. okrazenie']
                    bestLap = row['Naj. okrążenie']
                    laps = row['Okrążenia']
                    # laps = row['Okrazenia']
