...
input_dir = r"C:\Users\d.hanowicz\Desktop\AMC\Wyniki-automat\acc 2\acc\wyniki\Porsche CUP"
output_dir = r"C:\Users\d.hanowicz\Desktop\AMC\Wyniki-automat\acc 2\acc\wyniki\Porsche CUP"
output_csv_file = os.path.join(output_dir, "klasyfikacja_generalna.csv")
background_image = r"C:\Users\d.hanowicz\Desktop\AMC\Wyniki-automat\acc 2\acc\input\Week League\klasyfikacja generalna.jpg"
logo_image = r"C:\Users\d.hanowicz\Desktop\AMC\Wyniki-automat\acc 2\acc\input\Week League\Porsche CUP.jpg"
...
new_logo_width = 350  # Ustawienia szerokości dla logo
new_logo_height = 75  # Ustawienia wysokości dla logo
logo = logo.resize((new_logo_width, new_logo_height), Image.LANCZOS)

logo_x = 1500  # Ustawienia pozycji X dla logo
logo_y = 10  # Ustawienia pozycji Y dla logo
logo_rgba = logo.convert("RGBA")
bg_image.paste(logo_rgba, (logo_x, logo_y), logo_rgba)
