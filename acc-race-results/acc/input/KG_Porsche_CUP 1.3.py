...
input_dir = os.path.join(project_root, "acc", "output", "Porsche CUP")
output_dir = os.path.join(project_root, "acc", "output", "Porsche CUP")
...
output_csv_file = os.path.join(project_root, "acc", "output", "Porsche CUP", "klasyfikacja_generalna.csv")
logo_image = os.path.join(project_root, "files", "Logo", "Porsche CUP.png")
processed_files_log = os.path.join(project_root, "acc", "output", "Porsche CUP", "processed_files.txt")
...
bg_image.paste(logo, (logo_x, logo_y))
