...
input_dir = os.path.join(project_root, "acc", "output", "M2 CUP")
output_dir = os.path.join(project_root, "acc", "output", "M2 CUP")
...
output_csv_file = os.path.join(project_root, "acc", "output", "M2 CUP", "klasyfikacja_generalna.csv")
logo_image = os.path.join(project_root, "files", "Logo", "M2 CUP.png")
processed_files_log = os.path.join(project_root, "acc", "output", "M2 CUP", "processed_files.txt")
